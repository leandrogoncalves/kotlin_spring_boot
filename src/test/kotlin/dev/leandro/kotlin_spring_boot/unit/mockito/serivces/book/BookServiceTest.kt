package dev.leandro.kotlin_spring_boot.unit.mockito.serivces.book
...
import dev.leandro.kotlin_spring_boot.unit.mapper.mocks.MockBook
...
internal class BookServiceTest {
    ...
    fun findAll() {
        ...
        assertTrue(bookOne.links.toString().contains("</api/v2/book/1>;rel=\"self\""))
        ...
        assertTrue(bookFour.links.toString().contains("</api/v2/book/4>;rel=\"self\""))
        ...
        assertTrue(bookSeven.links.toString().contains("</api/v2/book/7>;rel=\"self\""))
    ...
    fun findById() {
        ...
        assertTrue(result.links.toString().contains("</api/v2/book/1>;rel=\"self\""))
